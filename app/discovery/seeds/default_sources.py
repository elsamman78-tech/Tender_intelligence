# Verified public seed library for the current V4 business scope.
# Global development-bank sources stay because they publish opportunities in Africa/MENA.
# Country-specific sources are limited to target markets; discovery expands coverage continuously.
SEED_SOURCES = [
    {
        ...
        'channels':[('TENDERS','https://projects.worldbank.org/en/projects-operations/procurement','HTML')]
    },
    {
        ...
        'channels':[('TENDERS','https://www.ungm.org/Public/Notice','HTML')]
    },
    {
    ...
    },
    {
        ...
        'channels':[('EOI','https://www.afdb.org/en/documents/project-related-procurement/procurement-notices/request-for-expression-of-interest','HTML'),('TENDERS','https://www.afdb.org/en/documents/category/specific-procurement-notices','HTML')]
    },
    {
        ...
        'channels':[('TENDERS','https://www.isdb.org/project-procurement/taxonomy/term/204','HTML')]
    },
    {
        ...
        'channels':[('TENDERS','https://www.ebrd.com/home/work-with-us/project-procurement/procurement-notices.html','HTML')]
    },
    {
    ...
    },
    {
        ...
        'source_type':'GOVERNMENT_PORTAL','country':'Saudi Arabia','languages':'ar','priority':'CRITICAL','trust_score':100,'relevance_score':95,'discovery_value':100,
        'channels':[('TENDERS','https://tenders.etimad.sa/Tender','HTML')]
    },
    {
    ...
    },
    {
        ...
        'source_type':'GOVERNMENT_PORTAL','country':'UAE','languages':'ar,en','priority':'CRITICAL','trust_score':100,'relevance_score':88,'discovery_value':96,
    ...
    },
    {
        ...
        'source_type':'GOVERNMENT_PORTAL','country':'Qatar','languages':'ar,en','priority':'CRITICAL','trust_score':100,'relevance_score':92,'discovery_value':96,
        'channels':[('TENDERS','https://monaqasat.mof.gov.qa/TendersOnlineServices/SearchTenders/1','HTML')]
    },
    {
    ...
    },
    {
        ...
        'channels':[('TENDERS','https://www.tenderboard.gov.bh/tenders/publictenders/','HTML')]
    },
    {
        'name':'Kuwait Central Agency for Public Tenders','domain':'capt.gov.kw','base_url':'https://capt.gov.kw/',
        'source_type':'GOVERNMENT_PORTAL','country':'Kuwait','languages':'ar,en','priority':'HIGH','trust_score':100,'relevance_score':90,'discovery_value':96,
        'channels':[('TENDERS','https://capt.gov.kw/ar/intranet/media/','HTML')]
    },
    {
        ...
        'channels':[('TENDERS','https://joneps.gov.jo/ep/invt/selectListTendInvitAL.do','HTML')]
    },
    {
        'name':'Iraq Unified Government Tenders Platform','domain':'itp.iq','base_url':'https://itp.iq/',
        'source_type':'GOVERNMENT_PORTAL','country':'Iraq','languages':'ar,en','priority':'CRITICAL','trust_score':100,'relevance_score':92,'discovery_value':100,
        'channels':[('TENDERS','https://itp.iq/','HTML')]
    },
    {
        'name':'Libya National Oil Corporation Tenders','domain':'noc.ly','base_url':'https://noc.ly/en/tenders/',
        'source_type':'PUBLIC_COMPANY','country':'Libya','languages':'ar,en','priority':'HIGH','trust_score':100,'relevance_score':78,'discovery_value':88,
